		...
		<View style={{ flex: 1, backgroundColor: Colors.colors.light }}>
			...
			>
				<View style={styles.header}>
					...
					<View style={styles.top}>
						<Image source={require("../../../assets/images/1.jpeg")} style={styles.av} />
			...
			<ScrollView style={{ marginTop: -60 }}>
				...
				<Animated.View style={[list.getLayout(), styles.list]}>
					<Storages image={require("../../../assets/images/on.png")} title={"One Drive"} />
					<Storages
						image={require("../../../assets/images/go.png")}
						title={"Google Drive"}
					/>
					<Storages image={require("../../../assets/images/dr.png")} title={"Dropbox"} />
				</Animated.View>
			</ScrollView>
		</View>
	);
